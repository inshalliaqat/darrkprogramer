...
const Nav = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("p", { className: "brand" }, "dark", /*#__PURE__*/

    React.createElement("strong", null, "Prog\xE9ramer")), /*#__PURE__*/
...
const Header = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("span", { className: "color" }, "&"), " coder.")), /*#__PURE__*/
...
const About = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("h4", { className: "subtitle" }, "My name in inshal."), /*#__PURE__*/
...
const Projects = props => {
  return /*#__PURE__*/(
    ...
    ' ', /*#__PURE__*/
    React.createElement("a", { href: "", target: "_blank", rel: "noopener noreferrer" }, "freeCodeCamp"), ", where I've been coding for almost 7 months non-stop until I completed all the projects required to get my Full-Stack Developer certification.")), /*#__PURE__*/
    ...
    React.createElement(Project, {
      ...
      link: "https://sub2unlock.org/649841bd85d9a",
      repo: "https://sub2unlock.org/649841bd85d9a" }, /*#__PURE__*/

    React.createElement("small", null, "Built using VS Code,Html+ CSS."), /*#__PURE__*/


    React.createElement("p", null, "This is a 3D Card Design with amazing hover efect")), /*#__PURE__*/
    ...
    React.createElement("small", null, "Built using VS Code,Html+ CSS javascript."), /*#__PURE__*/
...
const Contact = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("i", { className: "fas fa-at at" }), "darkprogramer", /*#__PURE__*/
...
const Footer = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("p", null, "\xA9 ", new Date().getFullYear(), " dark pro\xE9gramer."), /*#__PURE__*/
    React.createElement(SocialLinks, null))));
